...
# Configuration
base_config_path = "config/syracuse_mil_coral_xformer_au.yaml"
...
def main():
    ...
    for ratio in ratios:
        ...
        save_dir = f"Syracuse/xformer_mil_au_clip_level_auxiliary/5class_{ratio}_aug_ratio_au_features"
